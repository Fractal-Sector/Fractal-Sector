...
namespace Content.Client._FS.UserInterface.Controls;

/// <summary>
/// A rotary knob control used for the bark voice pitch/pitch variance/pause
/// sliders in the character editor. Extends the engine's Range control so it
/// gets Value/MinValue/MaxValue for free; only adds the rotary visual and
/// drag/scroll input handling plus an OnReleased event.
/// </summary>
