...
trait-hemophilia-desc = Ваш организм не способен формировать сгустки крови.
trait-monochromacy-name = Монохромазия
trait-monochromacy-desc = У вас полная цветовая слепота — всё, что вы видите, ограничивается оттенками чёрного и белого.
