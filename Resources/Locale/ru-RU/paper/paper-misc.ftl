...
book-text-agrichemkit-manual =
    ...
    Первый эксперимент: EZ Нутриенты
     ...
     Нестабильный мутаген абсолютно безопасен при использовании в качестве удобрения, и Руководящий орган Конкордии не несет ответственности за гибель урожая, чрезмерные счета за воду, вновь обретающие сознание растения, задающие экзистенциальные вопросы, или за гибель растений на фермах, которые могут случайно возникнуть при его использовании.
