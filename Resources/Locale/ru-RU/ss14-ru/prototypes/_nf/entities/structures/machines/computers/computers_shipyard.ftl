...
ent-ComputerShipyardSecurity = консоль приёма в ГМК
...
ent-ComputerShipyardNfsd = консоль верфи ГМК
    .desc = Здесь вы можете приобрести патрульные шаттлы ГМК, оснащенные новейшими технологиями и готовые к самым сложным заданиям. Поддержите закон и порядок среди звезд, используя надежные и мощные шаттлы, созданные для настоящих героев.
