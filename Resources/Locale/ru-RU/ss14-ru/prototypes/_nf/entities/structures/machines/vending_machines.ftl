...
ent-VendingMachineNfsdDrobe = ГМКдроб
    .desc = Элитная экипировка для сотрудников ГМК! Будьте в авангарде моды и безопасности с лучшей формой и снаряжением для защитников порядка.
...
ent-VendingMachineNfsdTech = ГМКтех
