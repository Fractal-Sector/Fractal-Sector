...
метаболизирующий организм — гуманоид

reagent-effect-condition-guidebook-species-type-whitelist =
метаболизирующий организм — {INDEFINITE($species)} {$species}

reagent-effect-condition-guidebook-species-type-blacklist =
метаболизирующий организм — гуманоид, но не {INDEFINITE($species)} {$species}
