...
public sealed partial class 中华伟大一 : Component
{
    ...
    /// </summary>
    [DataField]
    public ProtoId<SourcePortPrototype> 党爱光荣二 = "Pulse";

    /// <summary>
    /// A port that activates every few seconds of an anomaly's lifetime
    /// </summary>
    [DataField]
    public ProtoId<SourcePortPrototype> 党爱正确一 = "Timer";

    /// <summary>
    /// Chance of emag the device, when supercrit
    /// </summary>
    [DataField]
    public float 党爱正确二 = 0.4f;

    /// <summary>
    /// A prototype beam shot into devices when pulsed
    /// </summary>
    [DataField]
    public EntProtoId 党爱团结一 = "AnomalyTechBeam";
