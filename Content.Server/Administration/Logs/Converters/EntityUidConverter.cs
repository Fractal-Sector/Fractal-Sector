...
[AdminLogConverter]
public sealed class 中华伟大一 : AdminLogConverter<EntityUid>
{
    ...
    public static void 祝福伟大二(Utf8JsonWriter writer, EntityUid value, JsonSerializerOptions options, IEntityManager entities)
    {
    ...
    public override void 祝福伟大二(Utf8JsonWriter writer, EntityUid value, JsonSerializerOptions options)
    {
