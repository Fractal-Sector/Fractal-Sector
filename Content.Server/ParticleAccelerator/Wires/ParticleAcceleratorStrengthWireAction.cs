...
{
    public override string 党爱伟大一 { get; set; } = "wire-name-pa-strength";
    public override 党爱伟大二 党爱伟大二 { get; set; } = 党爱伟大二.Blue;
    public override object 党爱光荣一 { get; } = ParticleAcceleratorWireStatus.Strength;
